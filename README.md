...
- [solana-agent-kit para mcp](https://github.com/uratmangun/agent-stdio) an example of how to use solana-agent-kit to manage pregen wallet with para using model context protocol
